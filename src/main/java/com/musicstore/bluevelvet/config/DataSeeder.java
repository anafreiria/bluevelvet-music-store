...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        // --- 1. SEEDING ROLES (ADMIN, CLIENTE) ---
        Role roleAdmin = seedRole("ADMIN");
        Role roleClient = seedRole("CLIENTE");

        // --- 2. SEEDING USERS ---
        seedUser("Admin Master", "admin@bluevelvet.com", "123456", roleAdmin);
        seedUser("Client John Doe", "cliente@bluevelvet.com", "123456", roleClient);
